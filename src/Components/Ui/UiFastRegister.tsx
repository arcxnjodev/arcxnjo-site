...
export const UiFastRegister = () => {
  ...
  return (
    <div className="flex items-center mt-[50px]">
      <div className="relative flex items-center bg-gray-800 rounded-lg w-[280px] h-[50px] text-white focus:outline-purple-700">
        <p className="absolute text-md left-2 w-1/2">Arcxnjo.com/</p>
        <input
          type="text"
